...
const API_URL = "https://n8n.wranngle.com/api/v1/workflows?limit=100";
const API_KEY = process.env.N8N_API_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJmMjUxMmRkMS0wOTk0LTRjN2YtYWNmMS0wZWY4NDFhZjNhNjYiLCJpc3MiOiJuOG4iLCJhdWQiOiJwdWJsaWMtYXBpIiwiaWF0IjoxNzY4ODM4NTE3LCJleHAiOjE4OTM0NTYwMDB9.mZU-Kd_6ZaFmlrOxSYkIeFKlXw-Xy1at1w88XVbIdRk";
