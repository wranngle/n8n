...
const ELEVENLABS_API_KEY = process.env.ELEVENLABS_API_KEY || 'sk_733d2a2707d99f6bcdb9cc330570deea72390b20b6b2915e';
const SARAH_AGENT_ID = process.env.SARAH_AGENT_ID || 'agent_8001kdgp7qbyf4wvhs540be78vew';
...
If they explain who they are, politely end the call.`,
    expected_tool_calls: [],
    evaluation_criteria: [
      { id: "clarified_identity", name: "Clarified identity", prompt: "The agent clearly identified themselves as Wranngle Systems." },
...
Ask how Wranngle compares to competitors like Dialpad or Smith.ai.
You want to know what makes Wranngle different.`,
    expected_tool_calls: [],
    evaluation_criteria: [
      { id: "no_competitor_bashing", name: "No competitor bashing", prompt: "The agent did not speak negatively about competitors." },
      { id: "highlighted_value", name: "Highlighted value", prompt: "The agent focused on Wranngle's unique value proposition." }
    ]
  },
  {
...
async function main() {
  ...
  console.log('╠════════════════════════════════════════════════════════════════╣');
  console.log(`║  Agent: Sarah - Wranngle Receptionist                          ║`);
