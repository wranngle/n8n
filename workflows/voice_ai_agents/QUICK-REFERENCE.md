...
# Activate if needed
# Verify URL: https://n8n.wranngle.com/webhook/client-initiation-data
```
...
temp/sarah_updated_prompt.md                     # Agent prompt
```
...
data_source                # Source: "pipedrive" | "sheets" | "cache" | "none"
```

### Secret Variables (3)
```
secret__pipedrive_person_id    # Hidden from LLM, used in SMS tool
secret__pipedrive_org_id       # Hidden from LLM
...
### Request
```json
POST https://n8n.wranngle.com/webhook/client-initiation-data
...
# Outputs: JSON + CSV for Pipedrive/Sheets import
```
...
- [ ] Pipedrive credentials configured in n8n
