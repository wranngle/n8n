...
1. **`supersystem/client-initiation-data-prod.json`** (17KB)
   ...
   - Parallel Pipedrive + Google Sheets lookups
...
│
├── temp/
│   ├── sarah_updated_prompt.md
│   └── sarah_agent_backup_before_client_init.json
│
├── openspec/
...
- Pipedrive credentials configured
...
- Real-time cache invalidation (requires webhook from Pipedrive)
