...
Voice AI Agents is a production-grade infrastructure for building, testing, and deploying ElevenLabs voice agents integrated with n8n workflows and Twilio SMS capabilities. The project powers **Wranngle Systems' "The 24/7 Filter"** - AI hotlines that handle after-hours calls for small businesses (HVAC, plumbing, property management, legal services).
...
|-------|-------|---------|-------|
| Sarah (Wranngle Lead Specialist v2.0) | PROD | B2B Sales SDR for "The 24/7 Filter" | +1-888-266-2193 |
| SEWY Garage | DEV | Garage door repair booking | Not assigned |
...
### CRM
- **Pipedrive** - Lead/deal creation and management
...
### Key Terminology
- **The 24/7 Filter**: Wranngle's AI hotline product
...
| Pipedrive | CRM integration | API Key |
| Slack | Notifications | Webhook URL |

### Key Endpoints
- n8n: `https://n8n.wranngle.com/webhook/...`
