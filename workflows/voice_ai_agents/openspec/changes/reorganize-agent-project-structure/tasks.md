...
- [ ] 1.4 Run grep search: `rg "old/(agents-sarah-archive|agents-sewy-archive|pipelines-archive)" --type js --type yaml --type json`
...
- [ ] 3.1 Delete `old/agents-sarah-archive/` (8 files)
- [ ] 3.2 Delete `old/agents-sewy-archive/` (12 files)
- [ ] 3.3 Delete `old/sewy-garage-original/` (12 files - duplicate)
- [ ] 3.4 Verify agents/sarah/ still contains all active files
...
- [ ] 6.1 Delete `old/sarah-enhanced-prompt-v1.1.md`
- [ ] 6.2 Delete `old/sarah-final-prompt-100pct.md`
- [ ] 6.3 Delete `old/sarah-merged-prompt.md`
- [ ] 6.4 Delete `old/sarah-sms-tool.json`
- [ ] 6.5 Verify agents/sarah/tech-spec.md contains all prompt information
...
- [ ] 8.2 Review `sewy-garage` entry (lines 73-91)
- [ ] 8.3 EITHER: Mark as inactive OR create agents/sewy-garage/ structure
