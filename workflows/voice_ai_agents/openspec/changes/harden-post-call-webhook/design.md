...
| pipedrive_person_id | integer | CRM person ID (nullable) |
...
| Pipedrive | 3 | 2s linear | Log warning, continue |
...
| Pipedrive | YES | Continue - log warning, mark crm_updated=false |
...
9. **CRM Prep**
   ...
   - Skip if: pipedrive_person_id is null/0
...
4. **Rate Limiting**: Qdrant and Pipedrive have rate limits - respect backoff
