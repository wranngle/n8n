...
- Unconfigured Pipedrive credentials cause silent failures
...
- **ADDED** Graceful CRM degradation (continue if Pipedrive fails)
...
- **Affected systems**: n8n, Qdrant, Pipedrive, Slack, ElevenLabs
