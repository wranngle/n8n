...
WEBHOOK_URL="${N8N_WEBHOOK_URL:-https://n8n.wranngle.com/webhook/client-initiation-data}"
...
test_case "Full payload with all fields" "200" \
  "{\"caller_id\":\"+15559876543\",\"agent_id\":\"$AGENT_ID\",\"called_number\":\"+18882662193\",\"call_sid\":\"TEST123\"}"
